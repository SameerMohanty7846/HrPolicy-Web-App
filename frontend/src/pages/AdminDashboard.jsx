...
import HrLeavePolicy from './HrLeavePolicy'; // ✅ Added
  ...
  return (
    <div className="layout-bg d-flex" style={{ height: '100vh' }}>
      ...
      >
        ...
        <button className="sidebar-btn" onClick={() => setActiveComponent('leavePolicy')}>📋 HR Leave Policy</button> {/* ✅ New Button */}
